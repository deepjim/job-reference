...
var gamemode=-1;  //(0) Normal mode ; (1) Challenge mode
var cgrid={};
var i;
var j;
for (i=0;i<100;i++){
...
var fevers=0;
var feverAnimate = 0;
var time_end=Date.now()+gametime;
...
function enterfunc(){
if (Date.now()-time_end+gametime>2000 && Date.now()<time_end){
	var addfev=0;
	if (trailp>=3 && listp>0){
...
addEventListener("keypress",function (key){
	...
	else if ((key.keyCode==48 && fevers>50) && (Date.now()-time_end+gametime>2000 && Date.now()<time_end)) fever=1;
},false);
canvas.addEventListener("mousedown", function (event){
	var x=event.pageX - this.offsetLeft;
	var y=event.pageY - this.offsetTop;
	if (x>=50 && x < 123){
		if (y>=533 && y<606) innum(7);
		else if (y>=606 && y<679) innum(4);
		else if (y>=679 && y<752) innum(1);
	}
	else if (x>=123 && x < 196){
		if (y>=533 && y<606) innum(8);
		else if (y>=606 && y<679) innum(5);
		else if (y>=679 && y<752) innum(2);
	}
	else if (x>=196 && x < 269){
		if (y>=533 && y<606) innum(9);
		else if (y>=606 && y<679) innum(6);
		else if (y>=679 && y<752) innum(3);
	}
	else if (x>=277 && x < 425){
		if (y>=522 && y<610){
			if ((fevers>50) && (Date.now()-time_end+gametime>2000 && Date.now()<time_end)) fever=1;
		} else if (y>=612 && y<755) enterfunc();
	}
}, false);